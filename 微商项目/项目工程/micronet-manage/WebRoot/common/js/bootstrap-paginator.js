...
(function ($) {
    ...
    BootstrapPaginator.prototype = {
        ...
        render: function () {
            ...
            this.$element.addClass("pagination paginator-right");
            ...
            this.pageRef = [];
            if (pages.first || pages.first==null) {//if the there is first page element
                first = this.buildPageItem("first", pages.first);
                if(pages.first==null) first.addClass("disabled").children().unbind();
                if (first) {
                    listContainer.append(first);
                }

            }
            if (pages.prev || pages.prev==null) {//if the there is previous page element

                prev = this.buildPageItem("prev", pages.prev);
                if(pages.prev==null) prev.addClass("disabled").children().unbind();
                if (prev) {
            ...
            if (pages.next || pages.next==null) {//if there is next page

                next = this.buildPageItem("next", pages.next);
                if(pages.next==null) next.addClass("disabled").children().unbind();
                if (next) {
                    listContainer.append(next);
                }
            }

            if (pages.last || pages.last==null) {//if there is last page
                last = this.buildPageItem("last", pages.last);
                if(pages.last==null) last.addClass("disabled").children().unbind();
